...
const Navbar = () => {
  return (
    <div className="absolute top-0 left-0 w-full p-10 flex justify-between items-center z-50 m-5 motion-preset-slide-down">
      <div className="pointer-events-auto font-black  text-3xl ms-5">KERN.</div>
      <ul className="flex  text-md uppercase gap-10 font-semibold me-5">
