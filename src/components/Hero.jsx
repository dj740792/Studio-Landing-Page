...
const Hero = () => {
  return (
    ...
    >
      <h1 className="z-10 pointer-events-none flex flex-col mt-5 font-semibold font-mono text-[200px] ml-20 leading-[0.7] tracking-tighter motion-preset-slide-right motion-duration-2000">
        <span>Studio</span>
